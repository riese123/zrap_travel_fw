  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      BEGIN OF date_interval,
        msgid TYPE symsgid VALUE 'ZRAP_MSG_FW',
    ...
    CONSTANTS:
      BEGIN OF begin_data_before_system_date,
        msgid TYPE symsgid VALUE 'ZRAP_MSG_FW',
        ...
        attr4 TYPE scx_attrname VALUE '',
      END OF begin_data_before_system_date.
    CONSTANTS:
...
CLASS zcm_rap_fw IMPLEMENTATION.
